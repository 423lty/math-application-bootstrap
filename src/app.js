...
import instance from "./components/app/singleton.js"
...
class App {
     ...
     * @returns 正答率
     */
    #answerRate = (mistakeProblemLength) => mistakeProblemLength != 0 ? ((App.posedProblemList[0].length - mistakeProblemLength) * this.#answerRateCorrect) : this.#answerRateCorrect;
